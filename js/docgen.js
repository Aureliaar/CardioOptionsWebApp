...
function generate() {
    loadFile("interfaccia.docx",function(error,content){
        ...
        doc.setData({
            ...
            creatinine:String($('#creatinine').val()),
            creatinine18:checkboxPrint('#creatinine18'),
            serum_creatinine:String($('#serum_creatinine').val()),
            creatinine_clearance:String($('#creatinine_clearance').val()),
            peak_creatinine:String($('#peak_creatinine').val()),
            discharge_creatinine:String($('#discharge_creatinine').val()),
            ...
            prear_grade:$('[name=prear_grade]:checked').val(),
            eroa:String($('#eroa').val()),
            premr_grade:$('[name=premr_grade]:checked').val(),
            vena_contracta:String($('#vena_contracta').val()),
            preas_grade:$('[name=preas_grade]:checked').val(),
            ava:String($('#ava').val()),
            mean_gradient:String($('#mean_gradient').val()),
            jet_velocity:String($('#jet_velocity').val()),
            prems_grade:$('[name=prems_grade]:checked').val(),
            ...
            pulmonary_hypertension:checkboxPrint('#pulmonary_hypertension'),
            ...
            cha2ds2vasc_score:String($('#cha2ds2vasc_score').val()),
            hasbled_score:String($('#hasbled_score').val()),
